			...
			<body>
				<div class="container mt-5">
					...
					<div class="mt-2">
						...
						<form class="row" action="./blockFilter" method="post">
							<div class="col-4">
								<select name="blockId" id="blockNameId" class="form-control"
									onchange="getPanchayatByBlockId(this.value)">
									<option value="0">-select-</option>
							...
							<div class="col-2">
								<input type="text" class="form-control" name="vPop" id="popId" placeholder="pop...">
							</div>
				...
				<script type="text/javascript">
					...
					function filterByBlockAndPopulation(bId) {
						$.ajax({
							type: 'GET',
							url: 'blockFilter',
							data: {
