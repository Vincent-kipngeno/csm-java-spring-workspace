						...
						<div class="row">
							<div class="col-4">
								<label for="vnameId" class="font-weight-bold">Village
									Name</label> <input type="text" class="form-control" name="vName" id="vnameId"
									value="${v.name}">
							</div>
							<div class="col-2">
								<label for="popId" class="font-weight-bold">Population</label> <input type="text"
									class="form-control" name="vPop" id="popId" value="${v.population}">
							</div>
							...
							<div class="col-4">
								<label for="popId" class="font-weight-bold">Upload Auth Doc</label> <input type="file"
									class="form-control" name="adoc" id="adocId">
							</div>
						</div>
						<div class="mt-2 text-center">

							<input type="submit" class="btn btn-success"> <input type="reset" class="btn btn-warning">
						</div>
					</form>
				</div>
			</div>
